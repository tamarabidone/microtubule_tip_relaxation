...
xyz_filename = "../../md_trajectory_analysis/gdp-cacb-center-caonly-align-cg-nojump.xyz"
...
bond_coeff_lines = ["potentials/gdp_long_intra.table ENTRY", "potentials/gdp_long_inter.table ENTRY", "potentials/gdp_beta_lat_inter_all.table ENTRY", "potentials/gdp_alpha_lat_inter_all.table ENTRY", "potentials/gdp_seam_lat_inter_all.table ENTRY", "potentials/gdp_diag1_all.table ENTRY", "potentials/gdp_diag2_all.table ENTRY"]
...
angle_coeff_lines = [ "potentials/gdp_aba_long_angle_top.table ENTRY", "potentials/gdp_bab_long_angle_top.table ENTRY" ]
...
dihe_coeff_lines = [ "aat 1.0 177.0 180.0 potentials/gdp_long_dihe_top.table ENTRY", "aat 1.0 179.0 180.0 potentials/gdp_out_dihe_top.table ENTRY" ]
